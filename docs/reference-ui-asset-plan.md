...
| -------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Shared daytime coastal panorama              | Generated   | `apps/web/public/shared-assets/coastal-cove-day-v1.jpg`                                       | 564 KB delivery asset; only the runtime format is retained.                    |
| Login castle-island centerpiece              | Generated   | `apps/web/public/shared-assets/login-castle-island-v1.avif`                                   | 112 KB transparent delivery asset; only the runtime format is retained.        |
| General development-card icon                | Generated   | `apps/web/public/game-assets/ui/development-deck-v1.avif`                                     | Stacked-card artwork for the deck action; numeric counts remain code-rendered. |
| General unrevealed development card          | Planned     | —                                                                                             | Full portrait card face shared by concealed hand and deck counts.              |
| Bank action icon                             | Planned     | —                                                                                             | Compact bank-building symbol for the resource market and bank controls.        |
...
| Top-down ocean game canvas                   | Generated   | `apps/web/public/game-assets/ui/ocean-board-canvas-v2.webp`                                   | Quiet cyan water keeps the live board and HUD visually dominant.                |
...
| Eight player portraits                       | In progress | `apps/web/public/game-assets/players/`                                                        | Red is ready; seven color-matched portraits remain in the generation queue.    |
